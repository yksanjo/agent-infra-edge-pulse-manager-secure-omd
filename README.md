# agent-infra-edge-pulse-manager-secure-omd

## Detailed Description

agent-infra-edge-pulse-manager-secure-omd is a iot-focused project that evaluates device telemetry and operational anomalies to improve fleet reliability and safety.  
